...
http://localhost:8081/day15-EL/el/el3.jsp?hobby=&hobby=&id=<br/>
...
1. hobby의 [1]번째 값 : \${paramValues.hobby[1] } = ${paramValues.hobby[1] }
1. hobby의 [2]번째 값 : \${paramValues["hobby"][2] } = ${paramValues["hobby"][2] }
...
%>
<pre>
1. hobby의 [0]번 째 값 : <%=hobbies[0] %>
2. hobby의 [1]번 째 값 : <%=hobbies[1] %>
<%-- 3. hobby의 [2]번 째 값 : <%=hobbies[2] %> --%>
